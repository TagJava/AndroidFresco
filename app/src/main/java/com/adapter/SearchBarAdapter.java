...
public class SearchBarAdapter extends ArrayAdapter<String> {
    ...
    private boolean showSelectPic = true;
    private int textColor;

    public SearchBarAdapter(Context context, List<String> listData, int sId, int nId) {
    ...
    public SearchBarAdapter(Context context, List<String> listData, boolean bool) {
        super(context, R.string.no_data, listData);
        mContext = context;
        mListData = listData;
        showSelectPic = bool;
    ...
    public SearchBarAdapter(Context context, List<String> listData, int colorR) {
        super(context, R.string.no_data, listData);
        mContext = context;
        mListData = listData;
        textColor = colorR;
    ...
    public SearchBarAdapter(Context context, String[] arrayData, int sId, int nId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        LinearLayout view;
        if (convertView == null) {
            view = (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.choose_item, parent, false);
        } else {
...
//        textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, textSize);
        ...
        if (selectedText != null && selectedText.equals(mString)) {
            ...
            if (showSelectPic) {
                ...
                viewline.setVisibility(View.GONE);
                textView.setBackgroundColor(getContext().getResources().getColor(R.color.select_color));
            }
        }
